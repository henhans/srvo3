...
def run_dmft(params, config_file_name=None):
    ...
    full_params = None
    default_config_name = os.path.join('/home/thlee/git/triqs_tools/install_3.3.x/lib/python3.10/site-packages/solid_dmft/',#os.path.dirname(__file__),
    ...
    if general_params['csc']:
        ...
        csc_flow_control(general_params, solver_params, dft_params, gw_params, advanced_params, ghostGA=True)
